...
participant_trials_dir = '/Users/xuancheng/Desktop/master github/Code-Comprehension-Cheng/Participant_Trials_Comprehension_Results'
emip_metadata_file = '/Users/xuancheng/Desktop/master github/Code-Comprehension-Cheng/emip_dataset/emip_metadata.csv'
output_file = '/Users/xuancheng/Desktop/master github/Code-Comprehension-Cheng/local_metrics_behavioural_data_summary.csv'
...
for root, _, files in os.walk(participant_trials_dir):
    for file in files:
        if file.endswith('.csv'):
            ...
            Comprehension = data.iloc[0]['Comprehension_Question_Result']
...
## No difference comparing to original version, except for appending the new column "Comprehension_Result" and "Complexity"